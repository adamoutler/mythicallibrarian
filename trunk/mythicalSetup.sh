...
test -f /etc/mythicalLibrarian/JobSucessful && cat /etc/mythicalLibrarian/JobSucessful >> ./mythicalPrep
echo ' 			'>> ./mythicalPrep
echo ' 			#'>> ./mythicalPrep
...
echo ' 			#Insert Custom User Job here '>> ./mythicalPrep
test -f /etc/mythicalLibrarian/JobFilesystemError && cat /etc/mythicalLibrarian/JobFilesystemError >> ./mythicalPrep
echo ' 			'>> ./mythicalPrep
echo ' 			#'>> ./mythicalPrep
...
echo '  			#Insert Custom User Job here '>> ./mythicalPrep
test -f /etc/mythicalLibrarian/JobInformationNotComplete && cat /etc/mythicalLibrarian/JobInformationNotComplete >> ./mythicalPrep
echo ' 			'>> ./mythicalPrep
echo ' 			#'>> ./mythicalPrep
echo '  			exit 0'>> ./mythicalPrep
echo ' 			;;'>> ./mythicalPrep
...
test -f /etc/mythicalLibrarian/JobGenericError && cat /etc/mythicalLibrarian/JobGenericError >> ./mythicalPre
...
echo ' 	 			#Insert Custom User Job here'>> ./mythicalPrep
test -f /etc/mythicalLibrarian/JobInsufficientData && cat /etc/mythicalLibrarian/JobInsufficientData  >> ./mythicalPrep
echo ' 	 			'>> ./mythicalPrep
echo ' 				#'>> ./mythicalPrep
echo ' 				exit 3'>> ./mythicalPrep
echo ' 				;;'>> ./mythicalPrep
...
echo ' 				#Insert Custom User Job Here'>> ./mythicalPrep
test -f /etc/mythicalLibrarian/JobIgnoreList && cat /etc/mythicalLibrarian/JobIgnoreList >> ./mythicalPrep
echo ' 				'>> ./mythicalPrep
echo ' 				#'>> ./mythicalPrep
echo ' 				exit 0'>> ./mythicalPrep
echo ' 				;;'>> ./mythicalPrep
...
test "$mythtv" = "1" && chmod -R 777 "$AlternateMoveDir" "$AlternateMovieDir" $AlternateShowDir "/home/mythtv/Failsafe" "/var/www/mythical-rss">/dev/null 2>&1 
...
if [ "$mythtv" = "1" ]; then
 ...
 if [ "$nomythtvdb" != "1" ] && [ "$JobFoundInSlot" != "0" ]; then
  ...
  if [ "$SlotToUse" != "0" ]; then
   ...
   mysql -u$MySQLuser -p$MySQLpass -e "use mythconverg; UPDATE settings SET data='1' WHERE value='AutoRunUserJob$SlotToUse'";

...
if [ ! -f "./librarian" ]; then
 ...
 dialog --menu "Which version would you like to use?" 10 65 15 "Continue"  "using: $lastupdated" "Stable" "Download the most recent stable version" "Latest" "Download up-to-date SVN revision" 2>&1 >./downloadchoice)	
if [ "$?" = "1" ]; then
 	clear
